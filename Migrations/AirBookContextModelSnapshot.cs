...
{
    [DbContext(typeof(AirBookContext))]
    partial class AirBookContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("AirBook.Models.Reserva", b =>
                {
                    ...
                    b.Property<int?>("PasajeroIdPasajero")
                        .HasColumnType("int");

                    b.Property<int?>("VueloIdVuelo")
                        .HasColumnType("int");

                    b.HasKey("IdReserva");

                    b.HasIndex("PasajeroIdPasajero");

                    b.HasIndex("VueloIdVuelo");
            ...
            modelBuilder.Entity("AirBook.Models.Reserva", b =>
                {
                    b.HasOne("AirBook.Models.Pasajero", "Pasajero")
                        .WithMany()
                        .HasForeignKey("PasajeroIdPasajero");

                    b.HasOne("AirBook.Models.Vuelo", "Vuelo")
                        .WithMany()
                        .HasForeignKey("VueloIdVuelo");
